...
const Nav = ({ user }) => {
  ...
  // Detectar la ruta actual cuando el componente se monta y cuando cambia la URL
  useEffect(() => {
      ...
      <>
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-40">
            <div className="fixed top-0 left-0 z-50 h-screen w-72 bg-gray-900 text-white border-r border-gray-800 shadow-xl">

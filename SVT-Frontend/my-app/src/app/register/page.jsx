...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 px-4">
      <div
        className={`w-full max-w-md bg-gray-800/50 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-gray-700/40 transition-all duration-500 ease-out transform ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        }`}
      >
        <div>
          <h2
            className={`text-3xl font-bold text-white text-center mb-8 transition-all duration-300 ease-out transform ${
              isVisible
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            >
              ...
              />
              <div className="absolute right-3 top-3.5 transition-transform duration-150 hover:scale-110 active:scale-90">
                {showPassword ? (
                  <EyeOff
            ...
            {error && (
              <div
                className={`flex items-center space-x-2 text-red-400 bg-red-900/20 p-3 rounded-lg border border-red-800/30 transition-all duration-300 ease-out transform ${
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full bg-teal-800 hover:bg-teal-700 text-white py-3 px-4 rounded-xl font-medium border border-teal-700/70 transition-all duration-200 hover:scale-[1.03] active:scale-[0.97] ${
          ...
          <div
            className={`mt-6 text-center transition-all duration-300 ease-out transform ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-3"
            }`}
